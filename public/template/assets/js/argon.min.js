...
var DatatableBasic = function () {
    ...
    ,
    DatatableButtons = function () {
        var e, a = $("#datatable-absent_list_new");
        a.length && (e = {
            lengthChange: !1,
            dom: "Bfrtip",
            "aaSorting": [],
    ...
    ,
    DatatableButtons = function () {
        var e, a = $("#datatable-list-contract");
        a.length && (e = {
            lengthChange: !1,
            "order": [1,'desc'],
            dom: "Bfrtip",
    ...
    Accountant = function () {
        jQuery(document).ready(function($) {
            var e = $(".format_money").each(function (){
                var e =$(this).text();
                var a =accounting.formatMoney(e);
                $(this).text(a);
            });
        });
    }(),
...
! function (t) {
    ...
    t(function () {
        t(document).ready(function(e){
            var oke = $('#pop_up_success').attr("id");
            if(oke=="pop_up_success"){
                var oke1 = $('#pop_up_success').attr("name");
                var oke2 = $('#pop_up_success').attr("class");
                var oke3 = $('#pop_up_success').attr("message");
                console.log(oke2);
                swal({
                    title: "Success",
                    html: oke3+" !<br><div class='text-left h3' style='padding-left: 10%;padding-top: 15px;'> <div class='row'><div class='col'>Id</div><div class='col'> : "+oke2+"</div></div><div class='row'><div class='col'>Nama</div><div class='col'> : "+oke1+"</div></div></div>",
                    type: "success",
                    buttonsStyling: !1,
        ...
        t('[data-toggle="sweet-alert"]').on("click", function (e) {
            ...
            switch (t(this).data("sweet-alert")) {
                ...
                case "info":
                    swal({
                        title: "Info",
                        text: "Tunggu sebentar untuk proses ini !! Terkadang proses ini membutuhkan waktu beberapa menit",
                        type: "info",
                        buttonsStyling: !1,
                ...
                case "confirm":
                    ...
                    swal({
                        ...
                        // var id = $(t.currentTarget).attr("id");
                        console.log(id);
                        console.log(href);
                         if (t.dismiss === 'cancel') {
                            swal("Cancelled", "Your cancel deleted :)", "error");
                        }else if (t.value) {
                            t.value && swal({
                                title: "Deleted!",
